# This script can be used to create the boxmuller vivado project
...
# Create project
create_project boxmuller $project_location -part xczu28dr-ffvg1517-2-e
...
lappend source_files $source_dir/src/boxmuller.vhd
...
export_simulation -of_objects [get_files $project_location/boxmuller.srcs/sources_1/ip/mult_23_23_24/mult_23_23_24.xci] -directory $project_location/boxmuller.ip_user_files/sim_scripts -ip_user_files_dir $project_location/boxmuller.ip_user_files -ipstatic_source_dir $project_location/boxmuller.ip_user_files/ipstatic -lib_map_path [list {modelsim=$project_location/boxmuller.cache/compile_simlib/modelsim} {questa=$project_location/boxmuller.cache/compile_simlib/questa} {ies=$project_location/boxmuller.cache/compile_simlib/ies} {xcelium=$project_location/boxmuller.cache/compile_simlib/xcelium} {vcs=$project_location/boxmuller.cache/compile_simlib/vcs} {riviera=$project_location/boxmuller.cache/compile_simlib/riviera}] -use_ip_compiled_libs -force -quiet
